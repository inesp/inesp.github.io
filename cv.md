  ...
  <div class="career-item">
    ...
    <div class="career-body">
      ...
      <ul class="career-points">
        ...
        <li><b>Resilience</b>: a circuit breaker system guarding over <b>a million API calls a day</b>, PostgreSQL advisory locks and Redis distributed locks for cluster-wide concurrency, and transaction-aware Celery tasks across 7 queues.</li>
